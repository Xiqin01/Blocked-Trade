<template>
    <div class="header">
        ...
        <div class="header-left">
            ...
            <!-- 一个容器，里边是图标，图标是element plus的折叠图标 -->
            ...
            <!-- logo -->
            <!-- <img class="logo" src="../assets/img/ICBC_logo.jpg" alt="" /> -->
            <el-image class="logo" src="src\assets\img\ICBC_logo.jpg" fit="fill" />
        </div>
        <!-- 网站标题 -->
        <div class="web-title">阻滞资金监控平台</div>
